...
annual_premium_increase = st.slider('Annual Premium Increase %, 12 means today you pay 2 usd the next year you pay 2.24 and so on', min_value=0.0, max_value=30.0, value=12, step=1) / 100
