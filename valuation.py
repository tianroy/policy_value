...
annual_premium = st.slider('Annual Premium, eg: +4 means you pay 4 USD to policy owner per year', min_value=-10.0, max_value=20.0, value=4.0, step=0.1)
annual_premium_increase = st.slider('Annual Premium Increase %, 5 means: you pay 4 usd this year, the next year you pay 4x(1+5%)=4.2 usd and so on', min_value=0.0, max_value=30.0, value=0.0, step=1.0) / 100
