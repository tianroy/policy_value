...
annual_premium = st.slider('Annual Premium, eg: +3 means you pay 3 USD to policy owner per year', min_value=-10.0, max_value=20.0, value=3.0, step=0.1)
annual_premium_increase = st.slider('Annual Premium Increase %, 8 means: you pay 3 usd this year, the next year you pay 3x(1+8%)=3.24 usd and so on', min_value=0.0, max_value=30.0, value=8.0, step=1.0) / 100
