...
policy_size = 100  
st.text(f'Policy Size: {policy_size} USD, you will get at end of year after the event happens')
gender = st.selectbox('Gender', options=['male', 'female'])
starting_age = st.slider('Age', min_value=0, max_value=110, value=80, step=1)
annual_premium = st.slider('Annual Premium, eg: +3 means you pay 3 USD every year, premium is fixed every year for whole life insurance policy, first pay at beginning of next year', min_value=-10.0, max_value=20.0, value=3.0, step=0.1)
