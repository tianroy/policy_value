...
annual_premium = st.slider('Annual Premium, eg: +3 means you pay 3 USD to policy owner per year, premium is fixed every year for whole life insurance policy', min_value=-10.0, max_value=20.0, value=3.0, step=0.1)
